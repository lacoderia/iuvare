...
class OfficesControllerTest < ActionController::TestCase
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post :create, office: { address: @office.address, description: @office.description, latitude: @office.latitude, longitude: @office.longitude, schedule: @office.schedule, title: @office.title }
    end
  ...
  test "should update office" do
    patch :update, id: @office, office: { address: @office.address, description: @office.description, latitude: @office.latitude, longitude: @office.longitude, schedule: @office.schedule, title: @office.title }
    assert_redirected_to office_path(assigns(:office))
  end
